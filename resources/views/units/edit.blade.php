                ...
                <div class="card mb-3 card-help">
                    ...
                    <div class="card-body">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" value="{{ $unit->created_at ? $unit->created_at->format('d M Y H:i') : now()->format('d M Y H:i') }}" disabled>
                        </div>
                        <div class="mb-3">
                            <label class="form-label">Terakhir diubah</label>
                            <input type="text" class="form-control" value="{{ $unit->updated_at ? $unit->updated_at->format('d M Y H:i') : '-' }}" disabled>
                        </div>
                    </div>
                </div>
