...
@section('styles')
    <style>
        .image-preview-placeholder {
            width: 100%;
            height: 243px;  /* Sama dengan preview image */
...
@section('content')
    @include('layouts.shared.page-title', [
        ...
        'subTitle' => 'Buat artikel baru untuk memberikan informasi kepada pengunjung.',
        'breadcrumbs' => [
                            ...
                            <div class="col-md-6">
                                <div class="mb-0">
                                    <label for="image" class="form-label">
                                        Gambar Artikel <span class="text-danger">*</span>
                                    </label>
                                    <input type="file"
                                    ...
                                    <div id="image-preview" class="mt-2" style="display: none;">
                                        <img id="preview-img" src="" alt="Preview" class="img-thumbnail" style="max-height: 243px; width: 100%; object-fit: cover;">
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="card-body">
                        <div class="d-grid gap-2">
                            <button type="submit" class="btn btn-primary">
                                <i class="ti ti-device-floppy me-1"></i> Simpan Artikel
                            </button>
...
@section('scripts')
    @vite(['resources/js/pages/content-management/articles/article-create.js'])
