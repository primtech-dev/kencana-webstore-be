        ...
        <div class="card-body">
            ...
            <div class="alert alert-info mt-2 mb-4">
                <ul class="mb-0">
                    ...
                    <li>Kolom <strong>purchase_type</strong> diisi <code>online</code> (bisa checkout langsung di webstore) atau <code>manual</code> (diproses admin/hotline via WhatsApp) &mdash; kosongkan untuk default <code>online</code></li>
